        ...
        <div className="mt-6 flex items-center justify-center gap-3">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ? "bg-[#D7E2EA]"
                      : "bg-[#D7E2EA]/30 hover:bg-[#D7E2EA]/50",
                  )}
          ...
          {activeItem.href ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-[#D7E2EA]/60 hover:text-[#D7E2EA] transition"
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#D7E2EA]/5 text-sm text-[#D7E2EA]/40">
            No image
          </div>
        )}
      </div>
